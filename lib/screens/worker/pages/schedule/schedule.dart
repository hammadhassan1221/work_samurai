    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Expanded(
          child: ListView(
            children: [
              _scheduleComponents.getDistance(
                  imagePath: Assets.location,
                  text: "Location",
                  text1: "New York,USA"),
              Container(
              ...
              _scheduleComponents.getLocation(
                  imagePath: Assets.distance,
                  text: "Max Distance",
                  text1: "40km"),
              SliderTheme(
              ...
              _scheduleComponents.getDayTime(
                  day: "Mon",
              ...
              _scheduleComponents.getWedThur(
                  day: "Wed", time: "10:00 am - 5:00pm"),
              SizedBox(
                height: AppSizes.height * 0.02,
              ),
              _scheduleComponents.getWedThur(
                  day: "Thur", time: "10:00 am - 5:00pm"),
              SizedBox(
                height: AppSizes.height * 0.02,
              ),
              _scheduleComponents.getDayTime(
                  day: "Fri", time: "10:00 am - 5:00pm"),
              SizedBox(
                height: AppSizes.height * 0.02,
              ),
              _scheduleComponents.getDayTime(
                  day: "Sat", time: "Available All Day"),
              SizedBox(
                height: AppSizes.height * 0.02,
              ),
              _scheduleComponents.getDayTime(
                  day: "Sun", time: "Available All Day"),
              SizedBox(
                height: AppSizes.height * 0.02,
              ),
            ],
